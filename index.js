...
const nameBand = 'DREAM LEAGUE SOCCER 2016';
const nameSongs = [
	"SUNSET SONS - REMEMBER", /*1) (8.2)*/
	"MEDICINE", /*2*/
	"ON THE ROAD", /*3*/
	"IF YOU REMEMBER ", /*4*/
	"SOMEONE TO YOU", /*5*/
	"VROL", /*6*/
	"SPEAKERFACE", /*7*/
	"TAKE ME FOR A RIDE", /*8*/
	"ABER", /*9*/
	"SHINE A LIGHT", /*10*/
	"REMEMBER - ORIGINAL", /*11*/
	"FIREFLY", /*12*/
	"SHE'S GONE BY THE MORNING", /*13*/
	"MAHALO", /*14*/
	"SPEAKERFACE", /*15*/
	"HEAT OF THE NIGHT", /*16*/
	"BRING THIS ALL TOGETHER", /*17*/
	"REFORMATION", /*18*/
	"BLONDIE", /*19*/
	"JUST SO YOU KNOW", /*20*/
]
